...
def start(update: Update, context: CallbackContext):
    ...
    update.message.reply_photo(
        ...
        f"Please pay 500rs to receive a virtual number.\n\n"
...
def button_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "get_virtual_number":
        query.message.reply_text(
            "Please pay 500rs to get a virtual number. If you have already paid, please provide a screenshot so we can confirm and give you the virtual number."
        )
