...
def start(update: Update, context: CallbackContext):
  keyboard = [
      [
          InlineKeyboardButton("Get Virtual Number",
                               callback_data="get_virtual_number")
      ],
      [InlineKeyboardButton("🅿Pay via Paypal🅿", url="https://www.paypal.me/BadalPrajapati")],
      [InlineKeyboardButton("🌐Pay International🌐", url="https://skrill.me/rq/Badal/650/INR?key=CShvFQ-cnsD4PKxW4jekpUQ44sC")],
    [
        InlineKeyboardButton(
            "💰Pay via Crypto💰", callback_data="pay_via_crypto"
        )
    ],
      ...
      [
          InlineKeyboardButton(
              "How to use this bot",
              url="https://www.youtube.com/shorts/wC23vXpE2Hc")
      ],
      [
          InlineKeyboardButton("Provide Feedback of service",
                               url="https://forms.gle/8Rbi1t49ZkbiRuqy7")
      ],
  ]
...
def button_callback(update: Update, context: CallbackContext):
  ...
  if query.data == "get_virtual_number":
      ...
      query.message.reply_text("USDT - BEP20 Address: 0x0c2c298dF964088D71FCAc7C625eb36E420BA1B2")
  elif query.data == "crypto_usdt_erc20":
      query.message.reply_text("USDT - ERC20 Address: 0x0c2c298dF964088D71FCAc7C625eb36E420BA1B2")
  elif query.data == "crypto_usdt_trc20":
      query.message.reply_text("USDT TRC20 Address: TFGR4bLURdHXXP64pA8sAV6j4M3Us4Un8E")
  elif query.data == "crypto_btc":
      query.message.reply_text("BTC Address: bc1qqqyqwk7dz47u284hlaxm22ssvl64uzr94utvcm")
